...
- `data/grammar_materials_0001.sql` + `data/grammar_fts_0001.sql` — legacy grammar snippets plus public authored Hokkaido/Sakhalin chapter text (from sibling repos or committed snapshot)
